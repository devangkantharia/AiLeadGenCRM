...
// --- UPDATED with Event Form & Buttons ---
...
export default function SingleCompanyPage({
  ...
  const {
    ...
    // We can add refetching later if we want
  });

  if (isLoading) {
    return <p>Loading company details...</p>;
  }
  // ... (keep error and !company checks)
